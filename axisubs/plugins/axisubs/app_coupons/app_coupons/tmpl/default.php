...
<a class="btn btn-success" href="index.php?option=com_axisubs&view=apps&task=view&layout=view&app_layout=coupons&id=<?php echo $app->input->get('id'); ?>">
	<?php echo JText::_('PLG_AXISUBS_APP_COUPONS_LIST_VIEW'); ?>
</a>
