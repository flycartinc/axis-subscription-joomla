    ...
    t.fn.circliful = function(r, o) {
        ...
        return this.each(function() {
            ...
            var x = i.find(".circle"),
                ...
                y = 0,
                C = 0;
            if (e.start > 0 && e.target > 0 && (a = e.start / (e.target / 100), C = e.target / 100), 1 == e.animation) var w = window.setInterval(function() {
                k >= 3.6 * a ? (window.clearInterval(w), u = 1) : (k += h, y += C), k / 3.6 >= a && 1 == u && (k = 3.6 * a), y > e.target && 1 == u && (y = e.target), x.attr("stroke-dasharray", k + ", 20000"), 1 == e.showPercent ? g.text(parseInt(k / 360 * 100) + "%") : g.text(y)
            }.bind(x), f);
            else x.attr("stroke-dasharray", 3.6 * a + ", 20000"), 1 == e.showPercent ? g.text(a + "%") : g.text(e.target)
        })
    }
}(jQuery);